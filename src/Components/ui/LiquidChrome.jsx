...
export const LiquidChrome = ({
    ...
    `;
      ...
      vec4 renderImage(vec2 uvCoord) {
          ...
          float t1 = sin(uv.x * 2.0 + uTime);
          float t2 = cos(uv.y * 2.0 - uTime);
          
          vec3 color = mix(saffron, white, smoothstep(-1.0, 1.0, t1));
          color = mix(color, green, smoothstep(-1.0, 1.0, t2));
          
          // Add chrome-like shine
          float shine = abs(sin(uTime - uv.y - uv.x));
          color += shine * 0.2;
